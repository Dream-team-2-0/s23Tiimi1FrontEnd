  ...
  return (
    <div style={{ paddingLeft: '15%', paddingRight: '15%', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '70vh', flexDirection: 'column' }}>
      ...
      <p>
        ...
        tuotteemme on tehty vastuullisista raaka-aineista laatua ja trendikkyyttä unohtamatta. Olemme sitoutuneet tarjoamaan asiakkaillemme eettisiä
        ja vastuullisia vaihtoehtoja koiransa vaatetuksen suhteen.
      </p>
